            ...
            <div id="formDiv">
                ...
                <form className = "formCadastroProdutos" onSubmit={handleSubmit}>
                    ...
                    <div id="inputBlock">
                        ...
                        <div id="codeInput">
                            {!show?(
                                <input className="nobutton" type="number" value = {code} required onChange={(e) => setCode(e.target.value)} onBlur={(e) => addCode(e.target.value)}/>
                            ):
                            (
                                <input id = "readOnly" type="number" readOnly value = {code} required onChange={(e) => setCode(e.target.value)} onBlur={(e) => addCode(e.target.value)}/>
                            )}
